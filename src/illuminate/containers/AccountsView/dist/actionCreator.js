...
exports.getMoreAccountFailure = exports.getMoreAccountSuccess = exports.getMoreAccountList = exports.getAccountFailure = exports.getAccountSuccess = exports.getAccountList = void 0;
...
exports.getMoreAccountList = function (nextPageUrl) {
    if (nextPageUrl === void 0) { nextPageUrl = undefined; }
    return ({
        type: configureActions_1["default"].GET_MORE_ACCOUNTS_REQUEST,
        payload: { nextPageUrl: nextPageUrl }
    });
};
exports.getMoreAccountSuccess = function (responseData) { return ({
    type: configureActions_1["default"].GET_MORE_ACCOUNTS_SUCCESS,
    payload: { responseData: responseData }
}); };
exports.getMoreAccountFailure = function (errorData) { return ({
    type: configureActions_1["default"].GET_MORE_ACCOUNTS_ERROR,
    payload: { errorData: errorData }
}); };
